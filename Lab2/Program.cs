...
namespace Lab2
{
    internal class Program
    {
        ...
        {
            //För att få appen att fungera se till att ändra pathen både i Customer.cs och Store.cs specifikt för er dator till txt filerna som ligger i projekt foldern.
